...
public interface ItrUtil {
    ...
    static InputStream toInputStream(Iterable<String> iterable, String spearator) {
        return toInputStream(iterable.iterator(), spearator);
    }
